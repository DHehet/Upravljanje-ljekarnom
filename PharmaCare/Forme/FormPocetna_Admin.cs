...
{
    public partial class FormPocetna_Admin : Form
    {
        private Korisnik prijavljeniKorisnik;

        public FormPocetna_Admin()
        {
            InitializeComponent();
        }

        public FormPocetna_Admin(Korisnik korisnik)
        {
            InitializeComponent();
        ...
        private void FormPocetna_Admin_Load(object sender, EventArgs e)
        {
